...
/* ── 16→32 upscale & template definitions ── */

const C16 = [
  '#2D1B0E', '#ffffff', '#E8573A', '#FFB88C', '#FACC15',
  '#0E7B5F', '#3B82F6', '#8B5CF6', '#EC4899', '#92400E', '#FDE8D0',
];

const T16 = (tpl: string[]): (string | null)[][] =>
  tpl.map(row =>
    row.split('').map(c => {
      if (c === '.') return null;
      return C16[parseInt(c, 16)] ?? null;
    }),
  );
